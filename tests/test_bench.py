...
@pytest.mark.parametrize("name", ["e2e_v1.json", "e2e_v2.json", "e2e_v3.json", "e2e_v4.json", "e2e_v5.json", "e2e_v6.json", "e2e_v7.json", "e2e_v8.json"])
...
# SHA-256 of each dataset's test players as sealed (e2e_v1: c58c35a, e2e_v2: eb8add4, e2e_v3: b15eccc, e2e_v4: 995e09d, e2e_v5: ddee1cd, e2e_v6: c259842, e2e_v7: e212511, e2e_v8: see the commit adding it).
SEALED_TEST_SHA256 = {
