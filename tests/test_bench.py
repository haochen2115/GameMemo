...
@pytest.mark.parametrize("name", ["e2e_v1.json", "e2e_v2.json", "e2e_v3.json"])
...
# SHA-256 of each dataset's test players as sealed (e2e_v1: c58c35a, e2e_v2: eb8add4, e2e_v3: b15eccc).
SEALED_TEST_SHA256 = {
