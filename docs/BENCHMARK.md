...
| `e2e_v10` | v10_d1、v10_d2 | v10_t1 … v10_t8，128 题（`6b077be`） | 由不看代码的 agent 编写的综合集：每个玩家 4 道负例（从没答应过的承诺 / 关于人的近似 / 没提过的人 / 没提过的话题） |
...
| 2026-09-25 | main P5b | e2e_v10 test | 0.461 | 0.521 | 0.479 | e2e_v10 基线（`bench/baseline_e2e.json`） |
| 2026-09-25 | **P6b**（规则承诺 + 一行轨迹 + 按话题回答承诺题） | e2e_v10 test | **0.536** | **0.583** | 0.479 | **通过**：+0.076（按题聚类 CI [+0.031, +0.125]，31 胜 2 负）；承诺 0.083 → 0.271，轨迹 0.021 → 0.313；合入 main |
