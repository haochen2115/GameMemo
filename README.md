...
- 端到端评测（真实 LLM 写入，再按规则判分）：P1 在 e2e_v2 test 上从 0.448 升到 0.759；P2 在 e2e_v4 test 上从 0.693 升到 0.765（段位 / 手机的变化轨迹 0.333 → 1.000）。实验全过程（包括没通过的尝试）见 [docs/EXPERIMENTS.md](docs/EXPERIMENTS.md)。
